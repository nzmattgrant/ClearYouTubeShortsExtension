...
const dropDownButtonClassSelector = `${rowItemElementName} yt-touch-feedback-shape`;
const dropDownButtonImageClassSelector = `${dropDownButtonClassSelector}  .ytSpecTouchFeedbackShapeFill`;
